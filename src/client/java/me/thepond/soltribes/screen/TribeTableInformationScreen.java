...
public class TribeTableInformationScreen extends TribeTableScreen<TribeTableInformationScreenHandlerBlockEntity> {
    ...
    public TribeTableInformationScreen(TribeTableInformationScreenHandlerBlockEntity handler, PlayerInventory inventory, Text title) {
        super(handler, inventory, Text.literal("TRIBE INFO"));
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(textRenderer, "Name", this.width / 2 - TRIBE_TABLE_WIDTH / 2 + TRIBE_TABLE_PADDING, this.height / 2 - 50 + 20 - textRenderer.fontHeight / 2 - 1, 0xFFFFFF, false);
        ...
        context.drawText(textRenderer, "Description", this.width / 2 - TRIBE_TABLE_WIDTH / 2 + TRIBE_TABLE_PADDING, this.height / 2 - 50 + 48 - textRenderer.fontHeight / 2 - 1, 0xFFFFFF, false);
