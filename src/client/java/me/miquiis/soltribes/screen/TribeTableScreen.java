...
public class TribeTableScreen<T extends ScreenHandler> extends HandledScreen<T> {
    ...
    protected void drawTribeBackground(DrawContext context, int mouseX, int mouseY) {
        ...
        ScreenUtils.drawRect(context, this.width / 2 - (TRIBE_TABLE_WIDTH / 2), this.height / 2 - 52, TRIBE_TABLE_WIDTH, 12, 0xFF939393);

        context.drawText(textRenderer, getTitle(), this.width / 2 - (TRIBE_TABLE_WIDTH / 2) + TRIBE_TABLE_PADDING, this.height / 2 - 52 + textRenderer.fontHeight / 2 - 1, 0xFFFFFF, false);
        ...
        if (tribe != null) {
            ...
            context.drawText(textRenderer, tribeName, this.width / 2 + (TRIBE_TABLE_WIDTH / 2) - textWidth - TRIBE_TABLE_PADDING, this.height / 2 - 52 + textRenderer.fontHeight / 2 - 1, 0xFFFFFF, false);
            this.renderBanner(context, this.width / 2 + (TRIBE_TABLE_WIDTH / 2) - textWidth - TRIBE_TABLE_PADDING - 5, this.height / 2 - 52 + 1, 4);
            ScreenUtils.drawRect(context, this.width / 2 + (TRIBE_TABLE_WIDTH / 2) - textWidth - TRIBE_TABLE_PADDING - 12, this.height / 2 - 52 + 2, 2, 8, 0xFFb9b9ba);
        }
