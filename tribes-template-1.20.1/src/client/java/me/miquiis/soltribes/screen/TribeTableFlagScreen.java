...
public class TribeTableFlagScreen extends TribeTableScreen<TribeTableFlagScreenHandlerBlockEntity> {
    ...
    public TribeTableFlagScreen(TribeTableFlagScreenHandlerBlockEntity handler, PlayerInventory inventory, Text title) {
        super(handler, inventory, Text.literal("FLAG MANAGEMENT"));
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        ScreenUtils.drawScaledText(context, textRenderer, "Settlement Name", settlementNameField.getX(), this.height / 2 - 50 + 40 - 10, 0xFFFFFF, false, 0.8f);
        ...
        ScreenUtils.drawScaledText(context, textRenderer, "Settlement Description", settlementDescriptionField.getX(), this.height / 2 - 50 + 40 + 30 - 10, 0xFFFFFF, false, 0.8f);
