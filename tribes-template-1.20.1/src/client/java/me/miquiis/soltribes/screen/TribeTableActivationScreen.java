        ...
        for (int i = 0; i < numElements; i++) {
            ...
            if (this.handler.blockEntity.getTribeFounders().size() > i) {
                ...
                if (button.isHovered()) {
                    ...
                    if (!isAlreadyFounder) {
                        tooltip.add(Text.literal("\u00A7eRequires \u00A7a300 XP\u00A7e points."));
                        tooltip.add(client.player.totalExperience >= 300 ? Text.literal("Click to activate") : Text.literal("Not enough XP points"));
                    } else {
